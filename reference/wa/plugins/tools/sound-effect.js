  ...
  async run(m, { sock, command }) {
    try {
      ...
      switch (command) {
        ...
        case "alien":
          set =
            "-af afftfilt=real='hypot(re,im)':imag='0':win_size=512:overlap=0.75";
          break;
        case "ghost":
        ...
        case "immersive":
          set =
            "-af stereotools=mlev=1.7,volume=1.15,acompressor=level_in=1:threshold=0.4:ratio=2.5:attack=15:release=200,aecho=0.8:0.88:950|1250:0.3|0.25";
          break;
        case "whisper":
        ...
        case "chipdemon":
          set =
            "-af asetrate=65100,volume=1.5,afftfilt=real='hypot(re,im)*cos(0)':imag='hypot(re,im)*sin(0)'";
          break;
        case "megaphone":
