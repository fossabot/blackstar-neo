...
export default {
  ...
  category: "user info",
  async run(m, { sock, db, user: senderData, setting, command }) {
    ...
    const printMyLeaderboard = frame(
      "LIMIT",
      [
    ...
    if (command === "limit") return m.reply(printMyLeaderboard);
